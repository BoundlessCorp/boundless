    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-background to-secondary">
      <div className="max-w-md w-full p-8 bg-card rounded-lg shadow-lg border border-border">
        <div className="text-center">
          ...
          <div className="p-4 bg-secondary rounded-lg text-sm text-muted-foreground font-body">
            <p className="font-medium text-foreground mb-2">If you believe this is an error, you can:</p>
